...
export default function PayslipPrintPage() {
  ...
  if (loading) {
    // Skeleton shaped like the document itself, so print preview users see a
    // stable page instead of a centred spinner and a layout jump.
    return (
      <div className="min-h-screen bg-canvas py-8 px-4 sm:py-14" aria-hidden="true">
        <div className="max-w-2xl mx-auto space-y-3">
          <div className="skeleton h-9 w-40 ml-auto" />
          <div className="skeleton h-[480px] w-full rounded-card" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-canvas py-8 px-4 sm:py-14 print:py-0 print:px-0">
      <div className="max-w-2xl mx-auto">
        <div className="flex justify-end mb-3 no-print print:hidden">
        ...
        <Card padding="none" className="overflow-hidden print:shadow-none print:border-0 print:rounded-none">
          ...
          <div className="px-5 py-5 sm:px-8 sm:py-6">
            <div className="grid grid-cols-2 gap-x-8 gap-y-1.5 text-sm tabular-nums">
            ...
            <div className="flex justify-end mt-4 pt-4 border-t-2" style={{ borderColor: template.primaryColor }}>
              <div className="text-right">
                ...
                <p className="text-2xl font-semibold text-fg tabular-nums">{money(payslip.netPay)}</p>
              </div>
            </div>
