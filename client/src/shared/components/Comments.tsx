            ...
            <div className="flex-1 bg-surface-sunken rounded-xl px-3 py-2">
              <div className="flex items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  {c.author?.id === user?.id && (
                    <button onClick={() => remove.mutate(c.id)} className="opacity-0 group-hover:opacity-100 p-0.5 text-fg-subtle hover:text-red-500 dark:hover:text-red-400 transition-all">
                      <Trash2 size={11} />
                    </button>
                  )}
                </div>
      ...
      <div className="flex gap-2">
        ...
        <div className="flex-1 flex gap-2">
          <textarea
            ...
            className="flex-1 border border-line dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500 rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 resize-none"
          />
          <button
