...
import {
  Button, Card, CardHeader, EmptyState, PageBody, PageHeader, Spinner, StatTile, Tabs,
...
function MeterTile({ label, value, percent, barClass }: {
  ...
  return (
    <Card padding="sm">
      ...
      <p className="text-[19px] font-semibold text-fg leading-tight tracking-tight mt-1">{value}</p>
              ...
              <ChartCard title="Recent Feedback" subtitle="Star rating + optional comment left by the ticket requester">
                ...
                {csatResponses && csatResponses.total > csatResponses.limit && (
                  <div className="flex items-center justify-between mt-4 pt-3 border-t border-line-subtle">
                    ...
                    <span className="text-xs text-fg-subtle">Page {csatResponses.page} of {Math.ceil(csatResponses.total / csatResponses.limit)}</span>
