    ...
    <div className="p-6 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Send automated alerts to a Teams channel via Incoming Webhook</p>
        </div>
        {isConnected && (
          <span className="ml-auto flex items-center gap-1.5 px-3 py-1 bg-green-50 text-green-700 rounded-full text-xs font-semibold border border-green-200">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 space-y-5">
        ...
        <div>
          <p className="text-sm font-medium text-gray-700 mb-2">Send notifications for</p>
        ...
        <div className="flex gap-3">
          {isConnected && (
            <>
              <button
                onClick={testWebhook}
                className="flex items-center gap-2 px-4 py-2 border border-[#464eb8] text-[#464eb8] rounded-lg hover:bg-blue-50 text-sm font-medium"
              >
                <Send size={14} /> Test
              </button>
              <button
